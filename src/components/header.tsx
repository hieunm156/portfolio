...
function Header() {
  ...
  return (
    <div className="md:pt-3 top-0 sticky z-50 bg-[rgb(3,7,17)]">
      <div className="border-t-0 border-l-0 border-r-0 border-b bg-white/5 md:border border-dark-blue p-3 shadow-sm md:rounded-lg flex justify-between items-center">
